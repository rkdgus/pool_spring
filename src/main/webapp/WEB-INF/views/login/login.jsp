		...
		<div id="loginForm">
			...
			<div id="join_content">
				...
				<img src="${pageContext.request.contextPath }/resources/images/jointitle.png">
					<form action="${pageContext.request.contextPath }/login/login" method="post" id="f">
						<p>
					...
					<div id="other_btn">
						...
						<a href="#"><img src="${pageContext.request.contextPath }/resources/images/line.png"></a>
							&nbsp; &nbsp; &nbsp;
						<a href="${pageContext.request.contextPath }/join/join"><img src="${pageContext.request.contextPath }/resources/images/newJoin.png"></a>
					</div>
