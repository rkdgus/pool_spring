		...
		<div id="content">
			...
			<form id="update_f" action="update" method="post">
				...
				<table>
					...
					<tr>
						<td>반</td>
						<td><select name="cno" id="update_select">
					...
					<tr>
						<td class="ver">내용</td>
						<td><textarea name="content" id="update_content">${vo.content }</textarea>
						</td>
					</tr>
					<tr>
						<td>이미지</td>
				...
				.click(
						function() {
							if (confirm("글 작성을 취소하시겠습니까?")) {
								...
								location.href = "read${pageMaker.makeSearch(pageMaker.cri.page)}&cno=${cno }&bno="
										+ $("#bno").val();
							}
						})
